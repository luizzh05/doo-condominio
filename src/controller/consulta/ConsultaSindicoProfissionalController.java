...
public class ConsultaSindicoProfissionalController implements ActionListener {

    private final TelaConsultaSindicoProfissional tela;

    public ConsultaSindicoProfissionalController(TelaConsultaSindicoProfissional tela) {
        this.tela = tela;
        ...
        DemoTableData.carregarSindicosProfissionais(this.tela.getjTableResultado());
    }
