...
public class ConsultaCondominioController implements ActionListener {

    private final TelaConsultaCondominio tela;

    public ConsultaCondominioController(TelaConsultaCondominio tela) {
        this.tela = tela;
        ...
        DemoTableData.carregarCondominios(this.tela.getjTableResultado());
    }
