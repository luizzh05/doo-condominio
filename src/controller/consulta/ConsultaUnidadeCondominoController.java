...
public class ConsultaUnidadeCondominoController implements ActionListener {

    private final TelaConsultaUnidadeCondomino tela;

    public ConsultaUnidadeCondominoController(TelaConsultaUnidadeCondomino tela) {
        this.tela = tela;
        ...
        DemoTableData.carregarUnidadesCondominos(this.tela.getjTableResultado());
    }
