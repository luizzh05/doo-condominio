...
public class ConsultaMovimentoCaixaController implements ActionListener {

    private final TelaConsultaMovimentoCaixa tela;

    public ConsultaMovimentoCaixaController(TelaConsultaMovimentoCaixa tela) {
        this.tela = tela;
        ...
        DemoTableData.carregarMovimentosCaixa(this.tela.getjTableResultado());
    }
