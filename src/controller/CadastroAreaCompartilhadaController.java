...
public class CadastroAreaCompartilhadaController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == tela.getjButtonNovo()) {
            ...
            ConsultaAreaCompartilhadaController consultaController = new ConsultaAreaCompartilhadaController(telaConsulta);
    ...
    private boolean gravarAreaCompartilhada() {
        return true;
    }
}
