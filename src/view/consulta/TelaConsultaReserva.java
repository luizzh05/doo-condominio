 ...
 * @author aluno
 */
public class TelaConsultaReserva extends javax.swing.JDialog {

    /**
     * Creates new form TelaConsultaReserva
     */
    public TelaConsultaReserva(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBoxCampoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "ID", "Area Compartilhada", "Status" }));
        ...
        jTableResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Area Compartilhada", "Data Inicio", "Data Fim", "Status"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaReserva dialog = new TelaConsultaReserva(new javax.swing.JFrame(), true);
