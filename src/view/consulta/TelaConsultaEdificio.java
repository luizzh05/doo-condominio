 ...
 * @author aluno
 */
public class TelaConsultaEdificio extends javax.swing.JDialog {

    /**
     * Creates new form TelaConsultaEdificio
     */
    ...
    private void initComponents() {
        ...
        jLabeltitulo.setText("Consulta de Edificio");
        ...
        jComboBoxCampoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "ID", "Nome", "CNPJ", "Cidade", "Status" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEdificio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaEdificio dialog = new TelaConsultaEdificio(new javax.swing.JFrame(), true);
